  ...
  return (
    <>
      <div className={styles.list_wrapper}>
        {items.map((item) => (
          <div key={item.skuId} className={styles.item_container}>
            ...
            <p className={styles.price}>Rp {formatPrice(item.price)}</p>
          </div>
        ))}
      </div>
      <div className={styles.subtotal_wrapper}>
        <div>
          <p>Subtotal</p>
          <p className={styles.subtotal_price}>Rp {formatPrice(subtotal)}</p>
        </div>
        <div>
          <p>
      ...
      <div className={styles.total_wrapper}>
        <p>Total</p>
        <p className={styles.total_price}>Rp {formatPrice(total)}</p>
      </div>
    </>
  );
};
