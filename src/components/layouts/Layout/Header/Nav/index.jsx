    ...
    <nav className={navStyles}>
      ...
      <div className={styles.container_bottom}>
        ...
        <ul className={styles.links}>
          <li>
            <NavLink className={styles.link} to="/collections/products">
              Shop all
            </NavLink>
          </li>
          <li>
            <NavLink className={styles.link} to="/collections/hijab">
              hijab
            </NavLink>
          </li>
          <li>
            <NavLink className={styles.link} to="/collections/men">
              men
            </NavLink>
          </li>
          <li>
            <NavLink className={styles.link} to="/collections/women">
              women
            </NavLink>
          </li>
        </ul>
